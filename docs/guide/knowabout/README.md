...
1. [注册git](http://172.16.38.156/H5)
2. [注册confidence](http://doc.qknode.cn/login.action?os_destination=%2Findex.action&permissionViolation=true)
3. [注册jira](http://jira.qknode.cn/secure/Dashboard.jspa)
4. [注册蓝湖](https://lanhuapp.com/web/#/item)
5. OA
6. iconfont
7. 网络邮箱
8. vpn
...
3. [微前端](https://github.com/umijs/qiankun) 
4. [typescript](https://www.typescriptlang.org/)
5. [ts-node]
6. [小程序(uniapp)](https://uniapp.dcloud.io/README)。
7. 

## 开发环境

1. [nvm官网](https://github.com/coreybutler/nvm-windows)。 [nvm 下载地址](https://file.turingtopia.com/videopool/bf05179d33d864fac91d9443a9b17085/bf05179d33d864fac91d9443a9b17085.zip)。通过nvm安装node版本12.16.1。然后[yarn下载](https://file.turingtopia.com/videopool/bc0c3d5dc79d462b194f4a00a80bfb63/bc0c3d5dc79d462b194f4a00a80bfb63.msi)。[yarn官网](https://classic.yarnpkg.com/zh-Hans/)
2. [开发工具vscode](https://code.visualstudio.com/)。需要安装Vetur,Prettier - Code formatter,ESLint
3. [git下载](https://file.turingtopia.com/videopool/a509dd288e237a153ef7f1aad830b3ae/a509dd288e237a153ef7f1aad830b3ae.exe)
4. [抓包工具](https://www.zzzmode.com/mytools/charles/)
5. [MAC下vpn](http://doc.qknode.cn/pages/viewpage.action?pageId=16454659)
6. [Window下vpn](http://doc.qknode.cn/pages/viewpage.action?pageId=16454655)
7. 

## 项目介绍
1. [图灵联邦项目](http://doc.qknode.cn/pages/viewpage.action?pageId=10695962)
2. [亿刻相关项目](http://doc.qknode.cn/pages/viewpage.action?pageId=10694963)
...
1. 在Jenkins上面，注明
 - 项目的名称。(例如：a项目)
 - 线上地址。(例如：a.test.com)
 - 服务器的ip。(例如：192.16.7.58和192.168.7.68)
 - 当前项目的端口。(例如：3000)
